...
export class Backend implements backendInterface {
    ...
    async addRecord(arg0: string, arg1: bigint, arg2: bigint, arg3: bigint, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addRecord(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllRecordsWithIds(): Promise<Array<MeditationRecordWithId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRecordsWithIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalMinutes(): Promise<bigint> {
        if (this.processError) {
            try {
